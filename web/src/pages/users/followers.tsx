...
import { CDN_URL, fetchFollowers, fetchFollowing, followUser, unfollowUser } from '~/lib/api';
...
export default function UserFollowersPage() {
  ...
  return (
    <div>
      <ul
        class="text-foreground grid w-full grid-cols-2 text-center text-sm font-medium"
        id="default-tab"
        role="tablist"
      >
  ...
  return (
    ...
    >
      ...
      <Switch>
        ...
        >
          <button
            class="rounded-full bg-main px-4 py-2 text-white"
        ...
        >
          <button
            class="rounded-full bg-accent px-4 py-2 text-white"
