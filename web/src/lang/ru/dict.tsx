  ...
  pages: {
    ...
    users: {
      verificationStatusDenied:
        'Мы скрыли ваш профиль. Попробуйте сделать его более личным и настоящим.',
      ...
      edit: {
        ...
        description: {
          title: 'О себе',
          placeholder:
            'Например: 32 года, серийный предприниматель и директор по продукту с опытом в архитектуре, дизайне, маркетинге и разработке технологий.',
        },
        location: {
          title: 'Где вы живёте?',
        },
      ...
      fillProfilePopup: {
        ...
        description:
          'Заполните профиль всего за 5 минут, чтобы расширить возможности для общения и сотрудничества.',
      ...
      followSuccess:
        'Мы отправили уведомление о том, что вам понравился их профиль',
      ...
      links: 'Ссылки',
      linksUpdated: 'Ссылки успешно обновлены',
      linksUpdateError: 'Не удалось обновить ссылки',
      invalidUrl: 'Пожалуйста, введите корректный URL',
      addLink: 'Добавить ссылку',
      linkUrlPlaceholder: 'Введите URL',
      linkLabelPlaceholder: 'Введите название ссылки',
      fetchingMetadata: 'Загрузка информации о ссылке...',
      ...
      edit: {
        general: {
          ...
          descriptionPlaceholder:
            'Например: Ищу дизайнера для участия в некоммерционном хакатоне',
          checkboxPlaceholder: 'Оплачивается ли эта возможность?',
        },
        location: {
          title: 'Есть ли предпочтения по локации?',
          description:
            'Укажите место, которое лучше всего подходит для сотрудничества',
        },
        interests: {
          title: 'Выберите тему',
        ...
        badges: {
          title: 'Кого вы ищете?',
          description:
            'Выберите теги, которые лучше всего описывают вашу задачу',
