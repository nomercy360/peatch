...
const Toast = () => {
	...
	return (
		<div class="fixed bottom-4 left-1/2 z-50 -translate-x-1/2 transform space-y-2">
			{toasts().map(toast => (
				<div
					class={`flex w-[calc(100vw-2rem)] items-center justify-between rounded-lg ${getBackgroundColor(toast.type)} border border-white border-opacity-20 px-4 py-3 text-sm font-medium shadow-lg animate-in fade-in`}>
